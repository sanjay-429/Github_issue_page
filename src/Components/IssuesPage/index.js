...
const IssuesPage = () => {
  ...
  <Navbar.Brand href="#home"><img src="https://t3.ftcdn.net/jpg/01/89/75/78/240_F_189757839_LmjpECXmbUy5GPxxiz0IwVlByNt0ghqs.jpg" height="30px"></img>&nbsp;210 Open</Navbar.Brand>
  <Navbar.Toggle aria-controls="responsive-navbar-nav" />
  <Navbar.Collapse id="responsive-navbar-nav">
    <Nav className="mr-auto">
      <Nav.Link href="#features">1621 closed</Nav.Link>
